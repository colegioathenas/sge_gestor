...
if ($dados_aluno ['Nome'] == "") {
					...
					<div id="Dados_responsavel" style="height: 345px; overflow: auto">
						...
						<fieldset style='padding: 10px'>
							...
							<label style='margin-top: 5px'>CEP</label><input type="text"
								...
								style='margin-top: 5px'>Endereco</label><input type="text"
								name="resp_end_res_end" id="resp_end_res_end" size="80"
						...
						<fieldset style='padding: 10px'>
							...
							<label style='margin-top: 5px'>CEP</label><input type="text"
								...
								style='margin-top: 5px'>Endereco</label><input type="text"
								name="resp_end_com_end" id="resp_end_com_end" size="80" /> <br />
						...
						<label style='margin-top: 5px'>Tel. Res</label> (<input
							type="text" name="resp_res_ddd" id="resp_res_ddd" size="3" />)<input
							style='margin-left: 0px' type="text" name="resp_res_tel"
							id="resp_res_tel" size="10"
							value="<?php echo $dados_aluno['TelefoneResp']; ?>" /> <label
							style='margin-left: 11px'>Tel. Com</label> (<input type="text"
							name="resp_com_ddd" id="resp_com_ddd" style='margin-left: -30px'
							size="3" />)<input style='margin-left: 0px' type="text"
							name="resp_com_tel" id="resp_com_tel" size="10"
							value="<?php echo $dados_aluno['TelEmpresaResp']; ?>" /> <label
							style='margin-left: 11px'>Tel. Cel</label> (<input type="text"
							name="resp_cel_ddd" id="resp_cel_ddd" style='margin-left: -30px'
							size="3" />)<input style='margin-left: 0px' type="text"
							name="resp_cel_tel" id="resp_cel_tel" size="10"
							value="<?php echo $dados_aluno['CelularResp']; ?>" /> <br /> <label
							style='margin-top: 5px'>Email</label><input type="text"
					...
					<div id="forma_pagamento" style="height: 345px; overflow: auto">
						...
						<fieldset style='padding: 10px'>
							...
							echo "<table width='100%'>";
							echo "<tr>";
							echo "<td width='40%'><input type= \"radio\" name=\"fpg_material\" value=\"1\" >  A Vista (5% de Desconto) $valores_material[0]</input></td>";
							...
							<table width='100%' id="tb_fpg_uniforme">
								<tr>
									<td width='40%'><input type="radio" name="fpg_uniforme"
										value="1" style='display: none'><label id="fpg_uniforme1" /></input></td>
