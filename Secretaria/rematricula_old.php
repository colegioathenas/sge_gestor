				...
				<div id="tabs">
					<ul>
						<li><a href="#geral"><img src="../image/matricula.png"
								width="30px" />&nbsp;<?php echo ucwords($_REQUEST['tipo']); ?> 1/5</a></li>
					...
					<div id="geral"
						...
						<div style="height: 390px">
							...
							<label for="nome">Nome: </label> <input id="nome" name="nome"
								size="50" /> <br /> <label style='margin-top: 5px'>Serie:</label>
   					 	...
   					 	<img id="imgcaptcha" />
   					 	<br/>
   					 	<label for="captcha" style='margin-top:5px'>Captcha </label>
   					 	<input id="captcha" name="captcha" size="15" />
   					 	<a href='' id="btnValidar">Validar CPF</a>
   					 	<label id= "nome_resp"></label>
   					 -->
