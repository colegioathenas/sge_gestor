...
class indic {
	...
	function substituteIndic($earr, $lang, $font) {
		...
		// MALAYALAM
			...
			/*
			 * // Chillus - 0D7A-0D7E not in font directly, but as E005-E009 $vstr = preg_replace('/0D23 0D4D 200D/','0D7A', $vstr); $vstr = preg_replace('/0D28 0D4D 200D/','0D7B', $vstr); $vstr = preg_replace('/0D30 0D4D 200D/','0D7C', $vstr); $vstr = preg_replace('/0D32 0D4D 200D/','0D7D', $vstr); $vstr = preg_replace('/0D33 0D4D 200D/','0D7E', $vstr); $vstr = preg_replace('/0D7F/','E004', $vstr);	// [mlymChilluK] $vstr = preg_replace('/0D7A/','E005', $vstr);	// [mlymChilluNn] $vstr = preg_replace('/0D7B/','E006', $vstr);	// [mlymChilluN] $vstr = preg_replace('/0D7C/','E007', $vstr);	// [mlymChilluR] $vstr = preg_replace('/0D7D/','E008', $vstr);	// [mlymChilluL] $vstr = preg_replace('/0D7E/','E009', $vstr);	// [mlymChilluLl]
			 */
		...
		// TELUGU Shift Reph to LEFT [E046|E069|E077] [TelRaSmallOne] => E046 [TelRaSmallTwo] => E069 [TelRaSmallThree] => E077
			...
			$tevowels = "0C3E|0C3F|0C40|0C46|0C47|0C56|0C4A|0C4B|0C4C" . "|0C41|0C42|0C43|0C44"; // post matras
