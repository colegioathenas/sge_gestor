...
var curr_button_width = 0;
var curr_call_button_text;      // text showed on call button (click to call)
var curr_hangup_button_text;    // text showed on hangup button (click to call)
...
function SetBgColor()
{
    ...
    try{
		if (button_width != null && button_width > 0 && !isNaN(button_width))
		{
			curr_button_width = button_width;
		}else
		{
    ...
    {
        try{
        if (call_button_text != null)   curr_call_button_text = call_button_text;   else    curr_call_button_text = def_call_button_text;
        }catch (e) {curr_call_button_text = def_call_button_text;}
        
        try{
        if (hangup_button_text != null)   curr_hangup_button_text = hangup_button_text;   else    curr_hangup_button_text = def_hangup_button_text;
    ...
    if (document.getElementById("bg_container") != null)
    {
