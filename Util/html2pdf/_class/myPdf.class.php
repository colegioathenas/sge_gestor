...
class HTML2PDF_myPdf extends TCPDF {
	 ...
	 * @param string $unit
	 *        	User measure unit, same as TCPDF
	 * @param mixed $format
	 ...
	 *        	(top left corner)
	 * @param float $w
	 *        	(x+w = botom rigth corner)
	 * @param float $h
	 *        	(y+h = botom rigth corner)
	 * @param array $cornerTL
	 *        	radius of the Top Left corner
	 * @param array $cornerTR
	 *        	radius of the Top Right corner
	 * @param array $cornerBL
	 *        	radius of the Bottom Left corner
	 * @param array $cornerBR
	 ...
	 * @param float $rx        	
	 * @param float $ry        	
	 * @param float $angleBegin
	 *        	in radians
	 * @param float $angleEng
	 *        	in radians
	 * @param boolean $direction        	
	 * @param boolean $drawFirst,
	 *        	true => add the first point
	 * @param boolean $trans
	 *        	apply transformation
	 * @access protected
	 */
	 ...
	 *        	code to print
	 * @param string $type
	 *        	type of barcode (see tcpdf/barcodes.php for supported formats)
	 * @param int $x
	 ...
	 *        	of the Test Label. If false : no Label
	 * @param array $color
	 ...
	 * @param integer $sizeTitle
	 *        	Font size for hthe Title
	 * @param integer $sizeBookmark
	 *        	Font size for the bookmarks
	 * @param boolean $bookmarkTitle
	 *        	Bookmark the Title
	 * @param boolean $displayPage
	 *        	Display the page number for each bookmark
	 * @param integer $page
	 *        	draw the automatic Index on a specific Page. if null => add a page at the end
