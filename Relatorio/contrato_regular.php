...
<html>
  ...
  <body>
	...
	O objeto deste Contrato é a prestação de serviços educacionais ao aluno/beneficiário, indicado pelo(s) CONTRATANTE(s), referente ao período letivo de Janeiro a Dezembro de 2014, de acordo com o Projeto Político Pedagógico e Regimento Escolar da CONTRATADA.<br/>
	...
	<b>PARÁGRAFO SEGUNDO</b> – A prestação dos serviços educacionais, objeto deste contrato, tem seu início na data da assinatura do mesmo e seu término no último dia letivo previsto no calendário escolar de 2014.<br/>
	...
	<p class='paragrafo'><span class='destaque'>CLÁUSULA SEGUNDA – DAS CONDIÇÕES PARA A PRESTAÇÃO DOS SERVIÇOS</span><br/>
	...
	<b>PARÁGRAFO TERCEIRO</b> – É de exclusiva responsabilidade do(s) CONTRATANTE(s)  a aquisição de material escolar, constante de lista anexa ao presente Contrato, não configurando esta aquisição, em hipótese nenhuma, como parte integrante da anuidade aqui contratada.<br/>
	<b>PARÁGRAFO QUARTO</b> – O CONTRATANTE fica desde já ciente de que a Contratada não dispõe ou indica transporte escolar, sendo a utilização deste de inteira responsabilidade do(s) CONTRATANTE(s).<br/>
	<b>§ 1º</b> - Fica os CONTRATANTE(s)  ciente de que o aluno /beneficiário só poderá freqüentar as dependências da escola em turno oposto à sua matrícula, mediante autorização prévia da CONTRATADA, não constituindo obrigação da mesma a cessão de espaço físico e/ou material didático-pedagógico para atividades extracurriculares fora do horário de prestação de serviços contratados.<br/> 
	</p>	
	...
	<b>PARÁGRAFO PRIMEIRO</b> – O(s) CONTRATANTE(s), além da anuidade neste contrato pactuada, suportará todas as despesas adicionais para a educação inclusiva.<br/>
	<b>PARÁGRAFO SEGUNDO</b> –Para a efetivação da matrícula, será observada a disponibilidade de vagas, por turma, série/ano, na forma prevista no Regimento Escolar da CONTRATADA.<br/>
	...
	<b>PARÁGRAFO QUARTO</b> – Quando a necessidade especial for declarada pelo(s) CONTRATANTE(s), faz-se necessário que o mesmo apresente a avaliação psicodiagnóstica e/ou acompanhamento médico, psicológico ou psicopedagógico, assim como, o acompanhamento através de relatórios, no tempo hábil solicitado pelo Serviço de Orientação Educacional da Escola (CONTRATADA).<br/>
	<b>PARÁGRAFO QUINTO</b> – Quando a necessidade especial não for declarada pelo(s) CONTRATANTE(s), e o discente apresentar alguma dificuldade de aprendizagem em seu processo educativo, cognitivo ou relacional (dentro do espaço da Escola), a família será comunicada para que procure profissionais da área de saúde, apresentando os devidos relatórios para acompanhamento específico, pela Escola.<br/>
	<b>PARÁGRAFO SEXTO</b> – Fica o(s) CONTRATANTE(s) responsável (is) por promover (em) o contato com o profissional da área de saúde que esteja acompanhando diretamente o aluno com a escola, de modo que o mesmo possa orientar os profissionais da Instituição de Ensino de como acompanhar o educando, buscando um maior desenvolvimento social e cognitivo.<br/>
	<b>PARÁGRAFO SETIMO</b> – É de responsabilidade do(s) CONTRATANTE(s), o acompanhamento extraescolar de todas as necessidades pessoais e especiais do aluno, que possam facilitar e colaborar com seu desenvolvimento.
	</p>
	<p class='paragrafo'><span class='destaque'>CLÁUSULA QUARTA - DO VALOR DOS SERVIÇOS PRESTADOS</span><br/>
	Como contraprestação pelos serviços educacionais prestados ao (a) aluno (a) indicado (a) pelo contratante, durante o ano letivo de 2014, conforme previsto na cláusula segunda, o(s) CONTRATANTE(s)  pagará(m) à CONTRATADA, de acordo com o curso, série ou ano frequentados, o valor anual de R$ $contrato_anuidade ($contrato_anuidade_str) , podendo ser pago em até $contrato_qtd_parc_str ($contrato_qtd_parc), parcelas mensais no valor de R$ $contrato_mensalidade ($contrato_mensalidade_str) devendo ser a última no mês de Dezembro de 2014.<br/>
	<b>PARÁGRAFO PRIMEIRO</b> – O valor da contraprestação acima pactuado poderá ser reajustado quando expressamente permitido por lei, bem como para preservar o equilíbrio contratual, caso qualquer mudança legislativa ou normativa altere a equação econômico-financeira do presente instrumento.<br/>
	<b>PARÁGRAFO SEGUNDO</b> – A CONTRATADA, por mera liberalidade, poderá conceder descontos, a qualquer título, individual ou coletivamente, de forma contínua ou sobre determinada parcela específica, sobre valores devidos pelo(s) CONTRATANTE(s), o que não caracterizará novação, podendo, desta forma, esses descontos serem reduzidos ou cancelados, a qualquer tempo, a critério exclusivo da CONTRATADA.<br/>
	<b>PARÁGRAFO TERCEIRO</b> – O(s) CONTRATANTE(s) possui (em) conhecimento prévio das condições financeiras deste Contrato, que foram expostas na secretaria deste estabelecimento de ensino, (Lei no 9.870/99), conhecendo-as e aceitando-as livremente.<br/>
	<b>PARÁGRAFO  QUARTO</b> – A CONTRATADA poderá sem prévio aviso transferir os direitos e obrigações deste instrumento para outra personalidade jurídica ou terceiros sem prévio aviso.<br/>
	</p>
	<p class='paragrafo'><span class='destaque'>CLÁUSULA QUINTA  - DAS FORMAS E CONDIÇÕES DE PAGAMENTO</span><br/>
	O pagamento da primeira parcela da anuidade deverá ser efetuado no ato da matrícula, que só será reconhecida como efetivada, após a assinatura do contrato de prestação de serviços educacionais, pela CONTRATADA, e tem caráter de sinal, arras e princípio de pagamento, razão pela qual não será devolvida, no todo ou em parte, no caso de desistência por parte do(s) CONTRATANTE(s), sendo imprescindível sua quitação para celebração e concretização do presente Contrato.<br/>
	<b>PARÁGRAFO PRIMEIRO</b> – Os pagamentos das demais parcelas deverão ser efetuados até o 5º dia útil de cada mês, a partir do mês de Fevereiro de 2014, nos locais indicados pela CONTRATADA.<br/> 
	...
	<b>PARÁGRAFO OITAVO</b> – A CONTRATADA, a seu juízo, em caso de inadimplência poderá propor a rescisão do presente Contrato, independentemente da exigibilidade do débito vencido e seus consectários previstos no parágrafo segundo e demais ônus legais cabíveis, inclusive honorários advocatícios, custas e outras despesas processuais e de cobrança.<br/>
	<b>PARÁGRAFO NONO</b> – A CONTRATADA poderá valer-se do contrato, apurada a inadimplência do(s) CONTRATANTE(s) e a efetiva prestação do serviço pela CONTRATADA, para emitir e, se for o caso, protestar duplicatas e letras de câmbio de prestação de serviços, tudo em conformidade com a legislação vigente.<br/> 
	</p>
	<p class='paragrafo'><span class='destaque'>CLÁUSULA SEXTA – DA PRESTAÇÃO DE SERVIÇOS EDUCACIONAIS</span><br/>
	Os valores da contraprestação acima pactuada satisfazem, exclusivamente, a prestação de serviços decorrentes da carga horária constante da proposta curricular do Curso Regular da CONTRATADA e de seu calendário escolar.<br/>
	...
	<b>PARÁGRAFO SEGUNDO</b> – Os serviços extraordinários efetivamente prestados ao (a) aluno (a), dos quais citamos exemplificativamente cursos opcionais, cursos avulsos, cursos específicos, cursos decorrentes do regime de progressão parcial do aluno, atendimento ao aluno especial, em decorrência de laudo médico ou psicopedagógico, serviços de alimentação, atividades extraclasse, segunda chamada de provas, testes e exames, atividades de adaptação de estudos, segunda via de documentos: declarações, Carteira de Identificação Escolar; boletins de notas, Histórico Escolar, documentação de conclusão e transferência; serão cobrados à parte, independente dos valores ora contratados, os serviços extracurriculares e as taxas administrativas conforme descriminação à disposição na Secretaria da Escola.<br/>
	<b>PARÁGRAFO TERCEIRO</b> – Não estão ainda incluídos neste contrato os serviços especiais de reforço, dependência, transporte escolar, as segundas chamadas de provas ou exames, o uniforme, a alimentação e o material didático de uso exclusivo do BENEFICIÁRIO.<br/>
	...
	<p class='paragrafo'><span class='destaque'>CLÁUSULA SÉTIMA - DO USO DO UNIFORME ESCOLAR, DOS LIVROS DIDÁTICOS E APOSTILAS</span><br/>
	O Athenas Instituto de Educação, por mera liberalidade, adota o “Sistema de Ensino Etapa”, o qual está de acordo com a sua proposta pedagógica e com a Lei de Diretrizes e Bases da Educação Nacional e sua prestação de serviços de ensino ocorrerá mediante a utilização do MATERIAL DIDÁTICO, desenvolvido especialmente para os alunos das escolas conveniadas, atualizado periodicamente, constituindo, assim, um elemento essencial de sua Proposta Pedagógica. Para o bom andamento do trato pedagógico do(a) aluno(a) beneficiário.<br/>
	<b>§ 1º</b> – As obrigações referentes ao MATERIAL DIDÁTICO serão ajustadas em documento próprio, e este documento passa a fazer parte integrante do contrato.<br/>
	<b>§ 2º</b> – Fica(m) o(s) CONTRATANTE(s) ciente da obrigatoriedade de adquirir o material-didático pedagógico e de artes, necessário ao aprendizado do(a) aluno(a), cuja lista lhe é entregue durante o período de matrícula ou no inicio do ano letivo, bem como a fazer com que o(a) aluno(a) Beneficiário(a) se apresente devidamente uniformizado, assumindo inteiramente a responsabilidade por qualquer fato que venha a prejudicar o aluno pelo descumprimento.<br/>
	<b>PARÁGRAFO ÚNICO</b> – Na hipótese do não cumprimento do disposto no “caput” desta Cláusula, o aluno não poderá participar das atividades escolares, em conformidade com o disposto no Regimento Escolar, enquanto não atender à exigência.<br/>
	<b>§ 1º</b> – Fica(m) ciente(s) o(s) CONTRATANTE(s) de que é mera liberalidade da CONTRATADA fazer adoção do material didático-pedagógico em forma de módulos ou livros didáticos para todos os seus níveis de ensino.<br/> 
	<b>§ 2º</b> – A CONTRATADA disponibilizará uniforme completo para que o aluno (a) possa adquiri-lo, contendo: Camiseta, Blusão, Calça e Bermuda, cada um com o valor de acordo com a tabela disponibilizada na secretaria.<br/> 
	Não será permitido a permanência do ALUNO (A) que não estiver devidamente uniformizado nas dependências da escola.
	</p>
	<p class='paragrafo'><span class='destaque'>CLÁUSULA OITAVA - DO ATENDIMENTO MÉDICO HOSPITALAR</span><br/>
	...
	<p class='paragrafo'><span class='destaque'>CLÁUSULA NONA – DA RESCISÃO CONTRATUAL</span><br/>
	...
	<b>PARÁGRAFO QUARTO</b> – No caso de rescisão antes do início das aulas, o CONTRATANTE tem o direito de reembolso de 76% (SETENTA E SEIS POR CENTO) do valor pago, concordando desde já que os 24% (VINTE E QUATRO POR CENTO) retidos destinam-se ao custeio das atividades administrativas e operacionais.<br/> 
	</p>
	<p class='paragrafo'><span class='destaque'>CLÁUSULA DÉCIMA – DAS RESPONSABILIDADES QUANTO À MATRÍCULA E ÀS INFORMAÇÕES <br/>SOBRE A VIDA ESCOLAR DO ALUNO</span><br/>
	...
	<b>§ 1º</b> – As informações referentes ao Direito de Imagem, O(A) CONTRATADO(A) cede à CONTRATANTE o direito de uso de imagem/fotografia em peças promocionais, publicitárias e/ou acadêmicas, sem quaisquer ônus presentes ou futuros para as partes.<br/>
	As peças promocionais, publicitárias e/ou acadêmico de que trata a Cláusula anterior serão veiculadas por tempo indeterminado e em locais e veículos a critério da CONTRATANTE, sempre que convier à CONTRATANTE.<br/>
	...
	<p class='paragrafo'><span class='destaque'>CLÁUSULA DÉCIMA PRIMEIRA – DA RENOVAÇÃO DA MATRÍCULA</span><br/>
	A CONTRATADA não estará obrigada a renovar a matrícula do beneficiário do(s) CONTRATANTE(s), para o período letivo posterior, caso este não tenha cumprido rigorosamente as cláusulas do presente Contrato.	
	</p>
	<p class='paragrafo'><span class='destaque'>CLÁUSULA DÉCIMA SEGUNDA – DO FORO</span><br/>
	As partes atribuem ao presente Contrato plena eficácia e força executiva extrajudicial. Fica eleito o foro de  Arujá -SP comarca  de Santa Isabel - SP, para dirimir as dúvidas que o presente Contrato possa suscitar.<br/>
	...
	<table style='width:100%'>
		<tr>
			<td colspan='3' align='center'>ARUJA $data</td>
		</tr>
		<tr>
