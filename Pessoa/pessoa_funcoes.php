...
function atualiza_pessoa($rm, $nome, $endereco, $complemento, $cep, $cidade, $bairro, $uf, $rg, $cpf, $datanascimento, $naturalidade, $naturalidadeUF, $nacionalidade, $email, $pai, $mae, $respfin, $profissao, $estadocivil, $cepcom, $endcom, $bairrocom, $cidadecom, $ufcom, $codigo,  $negativado = 0 , $juridico = 0, $incluir = false) {
    if (trim ( $rm ) == "") {
        $rm = "0";
    }
