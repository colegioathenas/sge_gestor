...
<table width=666 cellspacing=0 cellpadding=0 border=0>
		...
		<TR>
			<TD valign=top class=cp><DIV ALIGN="left">
					...
					<li>Corte na linha indicada. Não rasure, risque, fure ou dobre a
						região onde se encontra o código de barras.<br>
					
					<li>Caso não apareça o código de barras no final, clique em F5 para
						atualizar esta tela.
					
					<li>Caso tenha problemas ao imprimir, copie a sequencia numérica
						abaixo e pague no caixa eletrônico ou no internet banking:<br>
					<br> <span class="ld2">
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		<tr>
			<td class=cp width=150><span class="campo"><IMG
					src="imagens/logocaixa.jpg" width="150" height="40" border=0></span></td>
  ...
  <?php echo $dadosboleto["nosso_numero"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1 src=imagens/2.png
					width=7 border=0></td>
				<td valign=top width=268 height=1><img height=1 src=imagens/2.png
					width=268 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=imagens/2.png
					width=7 border=0></td>
				<td valign=top width=156 height=1><img height=1 src=imagens/2.png
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tbody>
			<tr>
				...
				<td class=ct valign=top width=7 height=13><img height=13
					src=imagens/1.png width=1 border=0></td>
				<td class=ct valign=top width=112 height=13>(-) Outras deduuções</td>
				<td class=ct valign=top width=7 height=13><img height=13
					src=imagens/1.png width=1 border=0></td>
   ...
   <?php echo $dadosboleto["data_processamento"]?>
     ...
     <?php echo $dadosboleto["nosso_numero"]?>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src=imagens/2.png
					width=7 border=0></td>
				<td valign=top width=133 height=1><img height=1 src=imagens/2.png
				...
				<td valign=top width=7 height=1><img height=1 src=imagens/2.png
					width=7 border=0></td>
				<td valign=top width=102 height=1><img height=1 src=imagens/2.png
 ...
 <?php echo $dadosboleto["quantidade"]?>
   ...
   <?php echo $dadosboleto["valor_boleto"]?>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src=imagens/2.png
					width=7 border=0></td>
				<td valign=top width=43 height=1><img height=1 src=imagens/2.png
					width=43 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=imagens/2.png
					width=7 border=0></td>
				<td valign=top width=103 height=1><img height=1 src=imagens/2.png
...
<?php echo $dadosboleto["instrucoes6"]; ?></FONT><br>
					<br>
				</span></td>
